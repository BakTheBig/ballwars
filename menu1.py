...
class Settings(object):
    ...
    menu = {"root":["Play","Help", "Credits", "Options","Quit"],
            "Options":["mode","set BounceFactor","playerspeed","playermass","scorelimit","Change screen resolution","difficulty"],
            ...
            "difficulty": ["normal difficuty", "EXTREME difficulty"],
